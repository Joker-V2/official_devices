...
1. Download `vendor_boot.img` for **cheetah** from the [AxionOS website](https://cdn.axionos.org/#cheetah).
2. Reboot to the bootloader:
   ```
   adb reboot bootloader
   ```
...
1. Download `axion-*-cheetah.zip` from the [AxionOS website](https://cdn.axionos.org/#cheetah).
