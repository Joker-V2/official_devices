...
1. Download `vendor_boot.img` for **panther** from the [AxionOS website](https://cdn.axionos.org/#panther).
2. Reboot to the bootloader:
   ```
   adb reboot bootloader
   ```
...
1. Download `axion-*-panther.zip` from the [AxionOS website](https://cdn.axionos.org/#panther).
...
4. Sideload the ROM:
   ```
   adb sideload axion-*-panther.zip
   ```
