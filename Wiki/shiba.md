...
1. Download `vendor_boot.img` for **shiba** from the [AxionOS website](https://cdn.axionos.org).
2. Reboot to the bootloader:
   ```
   adb reboot bootloader
   ```
...
1. Download `axion-*-shiba.zip` from the [AxionOS website](https://cdn.axionos.org).
