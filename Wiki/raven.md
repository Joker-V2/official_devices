...
1. Download `vendor_boot.img` for **raven** from the [AxionOS website](https://cdn.axionos.org/#raven).
2. Reboot to the bootloader:
   ```
   adb reboot bootloader
   ```
...
1. Download `axion-*-raven.zip` from the [AxionOS website](https://cdn.axionos.org/#raven).
