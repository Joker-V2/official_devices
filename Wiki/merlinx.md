# Installation Guide — Redmi Note 9 (merlinx)
...
1. First of all, download and extract MIUI 12.5.4.0 RJOMIXM fastboot version.
2. Download and extract platform-tools inside the folder where you extracted MIUI 12.5.4.0.
