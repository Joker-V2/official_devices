...
1. Download `vendor_boot.img` for **husky** from the [AxionOS website](https://cdn.axionos.org).
2. Reboot to the bootloader:
   ```
   adb reboot bootloader
   ```
...
1. Download `axion-*-husky.zip` from the [AxionOS website](https://cdn.axionos.org).
