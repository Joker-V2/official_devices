# Installation Guide — OnePlus 8 (instantnoodle)
...
> - Flash **only** files meant for **OnePlus 8 (instantnoodle)**.
...
1. Download the **recovery** & **ROM** for your device from [here](https://cdn.axionos.org/#instantnoodle).
