# Installation Guide — Oneplus Ace 5 (giuliac)
...
> - Flash **only** files meant for **Oneplus Ace 5 (giuliac)**.
...
2. Dump the zip through payload dumper using this [guide](https://xdaforums.com/t/guide-how-to-extract-img-boot-img-etc-from-payload-bin-using-payload-dumper-go.4468781/) and grab **boot, vendor_boot, init_boot, recovery, and super_empty images**.
