# Installation Guide — Redmi note 7/7s (lavender)
...
> [!NOTE]
> - The device must have an **unlocked bootloader** and a **recommended custom [Recovery](https://github.com/Sa-Sajjad/Action-OFRP-Builder/releases/download/OrangeFox-FBE_V2-20250622/OrangeFox-R11.3_FBE-V2-Unofficial-lavender.zip)**.
> - Make a **full data backup** before flashing.
> - Ensure your device has at least **30% battery**.
> - Flash **only** files meant for **Redmi note 7/7s (lavender)**.
...
2. Wipe Cache, Dalvik cache, Data, Metadata
2. Flash the **ROM**.
3. *If you are using the **vanilla build**, flash **GApps** now.* *If you are using the **GMS build**, skip this step.*
4. Reboot back into **Recovery**.
5. Select **Wipe → Format Data** and type `yes`.
6. Reboot to **System**.
 ...
 **[Telegram Group](https://t.me/RedmiNote7Official)**
