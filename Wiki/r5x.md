# Installation Guide — realme 5/5i/5s (r5x)
...
> [!NOTE]
> - The device must have an **unlocked bootloader** and a **recommended custom [Recovery](https://github.com/Amritorock/Action-OFRP-Builder/releases/download/23895323043/recovery.img)**.
> - Make a **full data backup** before flashing.
> - Ensure your device has at least **30% battery**.
> - Flash **only** files meant for **realme 5/5i/5s (r5x)**.
 ...
 **[Telegram Group](https://t.me/Realme5Dev)**
